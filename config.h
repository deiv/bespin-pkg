...
typedef struct Config
{
    ...
    struct hack
    {
        bool messages, KHTMLView, treeViews, windowMovement, krunner, killThrobber, amarokContext;
    } hack;
    ...
    struct menu
    {
        ...
        bool showIcons, shadow, barSunken, boldText, itemSunken, activeItemSunken, glassy, round;
        int opacity;
    } menu;
